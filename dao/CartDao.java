...
public class CartDao {
	 ...
	 */
	private Cart readCart(String userid) {
		Cart cart = null;
	 ...
	 */
	public JSONArray getClientProducts(String userid) {
	...
	public String addProductToCart(String userid, String productid, int quantity) {
		...
		if (cart == null) {
			...
			result = insertProductToCart(userid, product, quantity);
			...
			if (quantity > product.getInstock()) {
				...
				result = updateClientCart(cart, product, quantity);
	 ...
	 */
	private String updateClientCart(Cart cart, Product product, int quantity) {
		String result = null;
	 ...
	 * @return	Success or Fail.
	 */
	private String insertProductToCart(String userid, Product product, int quantity) {
		String result = null;
	...
	public String checkoutCart(String userid) {
		...
		if (cart == null) {
			...
			String id = orderDao.createOrder(order);
